...
export default {
    ...
    onSubmit() {
      ...
      if (mqtt_instance.isConnected())
        mqttSendMessage(mqtt_instance, {
          topic: "status/" + btoa(this.phoneNumber) + "/msg/chat",
          payload: JSON.stringify({
            sender_id: btoa(this.user_phone),
            text: this.message,
          }),
        });
    },
  ...
  computed: {
    ...mapGetters(["is_authenticated", "is_authorized", "user_phone", "mqtt"]),
